    ...
    <section id='about'>
      ...
      <div className="container about_container">
        ...
        <div className="about_content">
          <p>Full Stack Developer with 3 years of experience in building scalable services
            using event-drive architecture. Proficient in both front-end and back-end
            development, with a strong understanding of modern web development
